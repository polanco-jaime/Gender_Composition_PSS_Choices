CREATE OR REPLACE TABLE `ICFES.SBTyT_PANEL`
OPTIONS (description="SABER TyT Desde 2016-2023 del periodo 1, el codigo de union esta en  01_research/third_paper_phd/Scripts/SQL/SBTYT.sql") AS
WITH 
SBTyT_20161 AS (
SELECT  
ESTU_TIPODOCUMENTO,
ESTU_NACIONALIDAD,
ESTU_GENERO,
PARSE_DATE("%d/%m/%Y",  ESTU_FECHANACIMIENTO ) ESTU_FECHANACIMIENTO,
PERIODO, --5
ESTU_CONSECUTIVO,
ESTU_ESTUDIANTE,
ESTU_PAIS_RESIDE,
...
TYT20231 AS  (
          SELECT  
                *
          FROM ( SELECT * FROM `ph-jabri.SABER_TyT.SBTyT_20231` WHERE ESTU_ESTADOINVESTIGACION = 'PUBLICAR' )
          LEFT JOIN 
          ph-jabri.SABER_TyT.Saber11_SaberTyT
...
ESTU_COD_MCPIO_PRESENTACION ESTU_COD_RESIDE_MCPIO,
'' ESTU_ESTADOCIVIL,
 CAST(COLE_NOMBRE_SEDE AS STRING)ESTU_COLE_TERMINO,--15
CAST(cole_cod_dane_institucion AS STRING) ESTU_CODDANE_COLE_TERMINO,
MUN_NAME ESTU_COD_COLE_MCPIO_TERMINO,
'' ESTU_OTROCOLE_TERMINO,
'' ESTU_TITULOOBTENIDOBACHILLER,
NULL ESTU_ANO_EXAMENESTADO_SB11, --20
'' ESTU_SEMESTRE_EXAMENESTADOSB11,
...
ESTU_ESTADOINVESTIGACION,
FROM TYT20231
LEFT JOIN (SELECT COLE_NOMBRE_SEDE, cole_cod_dane_institucion, MUN_NAME, ESTU_CONSECUTIVO AS ESTU_CONSECUTIVO_SB11_  FROM `ph-jabri.ICFES.SABER_11_2006_2023` ) A
ON ESTU_CONSECUTIVO_SB11_ = estu_consecutivo_sb11
),
SBTYT AS (
